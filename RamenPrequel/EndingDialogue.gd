...
func _ready():
	...
	var story = load("res://EndBaked.tres")
...
func _load_textures():
	var did = _Story_Reader.get_did_via_record_name("Ending/PictureLibrary")
